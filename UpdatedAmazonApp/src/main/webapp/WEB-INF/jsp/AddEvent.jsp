...
<body style="overflow:auto;" link="#66fcf1" vlink="white" alink="#0b0c10">
...
<br>
            ...
            <input id="poster" title="poster" type="file" name="poster" placeholder="Photo" method="post" required capture>
          </div>
          <div class="form-control">
...
<br>
					...
					<div class="form-control">
						...
						<input type="text" title="synopsis" id="synopsis" name="synopsis" placeholder="Enter a brief description"
						required method="post">
					</div>
					...
					<!-- <div class="form-control" id='duration' oninput="h.value = m.value +' '+ s.value">
						<label class="header"><mark style="background-color:#1f2833; color:white;">Duration:</mark></label>
					...
					<div class="form-control">
						...
						<input type="date" title="date" id="date" name="date" placeholder="Date of the event"
						required method="post">
					</div>
