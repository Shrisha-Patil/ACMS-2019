...
<div class="font">
   ...
   <div class="container">
   			...
   			<tbody>
            	...
            	<td>
   							...
   							<a type="button" class="btn btn-warning"
   								href="/DeleteEvent?id=${event.id}">Delete</a>
   						</td>
   					</tr>
   				</c:forEach>
   			</tbody>
      ...
      <br>
   		<div>
   			<a type="button" class="btn btn-success" href="/AddEvent"><p style="text-align: center;">Add</p></a>
   		</div>
   	</div>
<br>
<br>
<a href="/UserProfile"><p style="text-align:center;">Go Back to Your Profile</p></a>
